                                ...
                                <div class="col-sm-12">
                                    <div class="card" >
                                        <h5 style="margin-left:124px; font-size: 35px;font-style:bold; font-family: 'calibri';
                                            color:#007bff;" class="m-b-10">Add Institute Form</h5>
                                        <div class="card-body">
                                            <hr>
                                            <div style="margin-left:10px ;margin-top:-60px;opacity: 0.9;color: #007bff;font-family: cambria;;font-style: bold;font-size: 17px;" >
                                        <!--         <div class="col-md-6">
                                         -->            <form action="addInstitute" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="address" style="background-color: #f2f2f2" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="confirm-password" style="background-color: #f2f2f2" type="password" class="form-control" id="exampleInputPassword" placeholder="Confirm-Password">
                                                        </div>
                                                        </div>  
