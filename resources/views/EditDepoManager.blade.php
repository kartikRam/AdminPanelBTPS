...
<head>
    <title>Edit Depo Manager Form</title>
...
<body>
    ...
    <!-- [ Main Content ] start -->
    <div class="pcoded-main-container" style="background-image: url('assets/images/backgroundimage.jfif');background-repeat: no-repeat;" >
        <!--  -->
                        ...
                        <div class="page-block">
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <?php
                                         foreach($sql as $sql1){
                                            $name=$sql1->worker_name;
                                            $email=$sql1->worker_email;
                                            $password=$sql1->worker_password;
                                            $contact=$sql1->worker_contact_no;
                                            $branch=$sql1->branch_name;
                                         }
                                    ?> 
                    ...
                    <div style="transparent;opacity: 0.9;margin-left: 260px;margin-right: 260px;" class="main-body">
                        <div class="page-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card" >
                                        <h5 style="margin-left:84px; font-size: 35px;color: #007bff;font-style:bold; font-family: 'calibri';
                                            color:#007bff;" class="m-b-10">Edit Depo Manager Form</h5>
                                        <div class="card-body">
                                            <hr>
                                            <div style="margin-left:10px ;font-size:18px;background-color: transparent;opacity: 0.9;color: #007bff;" >
                                        <!--         <div class="col-md-6">
                                         -->            <form action="updateDepoManager" method="POST">
                                                            
                                                         @csrf
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Name</label>
                                                            <input type="text" name="name" class="form-control" size="55" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name" value="<?php echo $name;?>" />
                                                            <!-- 
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" name="email" class="form-control" size="55" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value="<?php echo $email;?>" /><!-- 
                                                            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="branch-name" class="form-control" size="55" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter branch-name" 
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="contact" class="form-control" placeholder=" Contact-No"  value="<?php echo $contact;?>"/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <button  style="margin-left: 155px;" type="submit" class="btn btn-info"  data-toggle="tooltip">Modify</button>                          
