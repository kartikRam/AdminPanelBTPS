                                ...
                                <br><br><div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                         ...
                                         <a href="AddInstituteForm"><button 
                                         style="margin-left:780px;margin-top:-40px;" type="button" class="btn btn-info"  data-toggle="tooltip">Add Institute+</button></a>
                                            <!-- 
                                            ...
                                            <div class="table-responsive">
                                                <table id="tableid_name" class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <th scope="row"><?php echo $res1->institute_id;?></th>
                                                            <td><?php echo $res1->institute_name;?></td>
                                                            <td><?php echo $res1->institute_email;?></td>
                                                            <td><?php echo $res1->institute_district;?></td>
                                                            <td><?php echo $res1->institute_address;?></td>
                                                            <td><?php echo $res1->institute_contact_no;?></td>
                                                             <td><a style="border-radius: 20px ;" 
                                                                href="deleteInstitute{{$res1->institute_id}}" class="label theme-bg2 text-white f-12">Remove</a>
                                                                <a href="EditInstitute{{$res1->institute_id}}" style="border-radius: 20px ;font-size: 12px;"  class="label theme-bg text-white f-12">Modify</a></td>
