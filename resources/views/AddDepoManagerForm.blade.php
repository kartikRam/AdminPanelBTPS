...
<head>
    <title>AddDepoManagerForm</title>
                                ...
                                <div class="col-sm-12">
                                    <div class="card" >
                                        <h5 style="margin-left:84px; font-size: 35px;color: #007bff;font-style:bold; font-family: 'calibri';
                                            color:#007bff;" class="m-b-10">Add Depo Manager Form</h5>
                                        <div class="card-body">
                                            <hr>
                                            <div style="margin-left:10px ;font-size:18px;background-color: transparent;opacity: 0.9;color: #007bff;" >
                                        <!--         <div class="col-md-6">
                                         -->            <form action="addDepoManager" method="POST">

                                                        @csrf <!-- {{ csrf_field() }} -->

                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Name</label>
                                                            <input type="text" name="name" class="form-control" size="55" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name"><!-- 
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" name="email" class="form-control" size="55" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"><!-- 
                                                            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="branch-name" class="form-control" size="55"  aria-describedby="emailHelp" placeholder="Branch-Name"><!-- 
                                                            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                                        </div>
<!-- 
                                                        <div class="form-group">
                                                            <label for="exampleFormControlSelect1">Branch-Name</label>
                                                            <select name="branch-name" class="form-control" id="exampleFormControlSelect1">
 ...
 -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" name="confirm-password" class="form-control" id="exampleInputPassword" placeholder="Password">
                                                        </div>
                                                        <div class="form-group form-check">
                                                            ...
                                                            <label style="font-size: 12px;" class="form-check-label" for="exampleCheck1">Show Password</label>
                                                                ...
                                                                var y = document.getElementById("exampleInputPassword");
                                                                  if (x.type === "password") {
                                                                    x.type = "text";
                                                                    y.type = "text";
                                                                  } else {
                                                        ...
                                                        <button style="margin-left: 180px; background-color: #007bff;" type="submit" class="btn btn-info"  data-toggle="tooltip">Add +</button>
